...
public class ConduitLoginPage extends TestBase {
    ...
    public static String conduitLabelXpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[1]/android.widget.FrameLayout[2]/android.webkit.WebView/android.view.View[1]/android.view.View[1]/android.view.View[1]";
    ...
    public static MobileElement getConduitLabelXpath() {
        return (MobileElement) loadDriver().findElementByXPath(conduitLabelXpath);
    }
